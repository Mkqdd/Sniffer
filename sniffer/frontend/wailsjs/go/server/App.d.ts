...
export function AddDefaultHeuristicRules():Promise<number>;

export function CheckPermission():Promise<void>;

export function ClearAllAlertRules():Promise<number>;
...
export function GetAppClassificationAccuracy():Promise<number>;

export function GetAppClassificationStats(arg1:number,arg2:number):Promise<server.ProcessStatsResult>;

export function GetClassificationAccuracy():Promise<number>;
...
export function GetMaltrailEvents(arg1:number,arg2:number,arg3:string,arg4:string):Promise<model.MaltrailEventList>;
...
export function ImportMaltrailTrails(arg1:string,arg2:boolean,arg3:string,arg4:boolean):Promise<server.ImportMaltrailTrailsResult>;

export function InsertTestMaltrailEvent():Promise<void>;

export function IsCapturing():Promise<boolean>;

export function IsPaused():Promise<boolean>;

export function ListIntelCategories():Promise<Array<store.IntelCategory>>;
...
export function RefreshReplayDatabase():Promise<void>;

export function ResumeCapture():Promise<void>;

export function RunProcessScript(arg1:string):Promise<void>;

export function SetIntelCategoryEnabled(arg1:string,arg2:boolean):Promise<void>;

export function StartAppClassificationScheduler(arg1:number,arg2:number):Promise<void>;

export function StartCapture(arg1:string):Promise<void>;

export function StartCaptureWithDB(arg1:string):Promise<void>;

export function StopCapture():Promise<void>;

export function SyncIntelFromMaltrail(arg1:string,arg2:string):Promise<server.IntelSyncResult>;
